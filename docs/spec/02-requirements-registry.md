...
| ID | Priority | Status | Requirement | Source |
|---|---|---|---|---|
| `INT-001` | P0 | implemented | AI calls route through Vercel AI SDK (`ai` + `@ai-sdk/anthropic` + `@ai-sdk/google` + `ollama-ai-provider-v2`) | BMAD-SRC-003 §Decision 1; corrected by `BUG-001` |
