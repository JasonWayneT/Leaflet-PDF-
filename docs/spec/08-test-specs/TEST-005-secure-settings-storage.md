...
|---|---|---|---|
| `TEST-005-A` | `SEC-001` | Key store set/get/delete uses service `Leaflet PDF-v2` and provider account names | `packages/electron-app/src/main/key-store.test.ts` compiles with mocked keytar driver |
