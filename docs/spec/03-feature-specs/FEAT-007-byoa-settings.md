...
| `TASK-021` | `INT-001`, `ARCH-002` | `ai-client.ts` + `providers/`: unified generateText(), all 3 adapters, Result<T> errors | completed |
| `TASK-022` | `SEC-001`, `INT-001` | `SetupWizard.tsx`: 5-step wizard, test connection, model auto-assignment | completed |
